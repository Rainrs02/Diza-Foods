...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      ...
      <div class="p-6 bg-forest-50 border-l-4 border-forest-500 rounded-r-lg mt-8 mb-8">
        ...
        <a href="/konsultasi" class="inline-block px-6 py-3 bg-forest-600 text-white font-medium rounded-lg hover:bg-forest-700 transition-colors">Coba Kalkulator B2B Sekarang</a>
      </div>
    `
  },
  {
    ...
    content: `
      ...
      <div class="p-6 bg-charcoal-50 border border-charcoal-200 rounded-lg mt-8">
        ...
        <a href="https://wa.me/62895405233323" target="_blank" class="inline-flex items-center px-6 py-3 bg-green-500 text-white font-medium rounded-lg hover:bg-green-600 transition-colors">
  ...
  },
  {
    ...
    content: `
      ...
      <div class="p-6 bg-forest-50 border-l-4 border-forest-500 rounded-r-lg mt-8">
        ...
        <a href="/konsultasi" class="inline-block px-6 py-3 bg-forest-600 text-white font-medium rounded-lg hover:bg-forest-700 transition-colors">Hitung Estimasi Biaya</a>
      </div>
    `
  },
  {
    ...
    content: `
      ...
      <div class="p-6 bg-charcoal-50 border border-charcoal-200 rounded-lg mt-8">
        ...
        <a href="https://wa.me/62895405233323" target="_blank" class="inline-flex items-center px-6 py-3 bg-forest-600 text-white font-medium rounded-lg hover:bg-forest-700 transition-colors">Hubungi Tim Desain Kami</a>
      </div>
    `
  },
  {
